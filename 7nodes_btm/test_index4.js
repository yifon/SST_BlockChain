...
var initCallback= function(jsonRes){
	...
	*/
	...
	var contractInitVars = {contractABI:jsonRes.contractABI, web3http:"http://localhost:7102", atmAdd:jsonRes.accounts[2].atms[1].address, ownerBank:jsonRes.accounts[2].address, contractAdd:jsonRes.contractAdd};
