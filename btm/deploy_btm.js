...
Deployer ={
  ...
  deploy: function(contractfile, web3http, arg){
        ...
        */
        ...
        if(arg == undefined){
          ...
          */
          ...
          var simple = simpleContract.new(arg, {from:web3.eth.accounts[0], data: bytecode, gas: 0x47b760}, function(e, contract) {
...
Deployer.deploy("BTM", "http://localhost:22000");//deploy BTM
