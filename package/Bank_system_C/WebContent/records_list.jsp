...
<head><link rel="stylesheet" type="text/css" href="<%=path %>/admin.css">
  ...
  <tr>
    <td class="border_left border_right border_bottom" height="400" valign="top" align="center">
        ...
        <tr class="tabletop">
        <a href="/Bank_system_C/BankTransactionRecordServlet?method=list" >Get Bank C Transaction Record</a>
            <td height="40" colspan="15" align="center">Bank C Transaction List</td>
		  </tr>
         <tr class="tablemenu">
