...
client.emit("userName", "Bank A A002 Connected");
...
var _httpRes ;
var thisHash;
var contractInitVars = {contractfile:"BTM",web3http:"http://localhost:7102", atmAdd:"0x81743ae6efb798ae288fa724aace76dcf8835e37", ownerBank:"0x01751f1b5a22aaee0824d68b888f2190a663d768", contractAdd:"0x8182dd293942ff6839e6e8c8a71981bb8ad655e5"};
...
//to send request to atmp here
	...
	if(check[4]==='cdp'){
		...
		callclientTFR({txnType:txnType,stepId:2,startNode:'Blockchain',nextNode:'A002',cardNumber:'',txnAmount:'0', cardBank:'Bank A',sourceATM:'', minerATM:minerATM,fee:'0',balance:'0',status:1});
		callclientTFR({txnType:txnType,stepId:3,startNode:'A002',nextNode:'aBank',cardNumber:'',txnAmount:'0', cardBank:'Bank A',sourceATM:'', minerATM:minerATM,fee:'0',balance:'0',status:1});
    }else{
    	 callclient({txnType:txnType,stepId:2,startNode:'Blockchain',nextNode:'A002',cardNumber:'',txnAmount:'0', cardBank:'Bank A',sourceATM:'', minerATM:minerATM,fee:'0',balance:'0',status:1});
    	 callclient({txnType:txnType,stepId:3,startNode:'A002',nextNode:'aBank',cardNumber:'',txnAmount:'0', cardBank:'Bank A',sourceATM:'', minerATM:minerATM,fee:'0',balance:'0',status:1});
    }
...
var checkCreditCallbak = function(contractOutput){
    ...
    callclient({txnType:txnType,stepId:3,startNode:'A002',nextNode:'aBank',cardNumber:'',txnAmount:'0', cardBank:'Bank A',sourceATM:'', minerATM:minerATM,fee:'0',balance:'0',status:1});
		...
		callclientTFR({txnType:txnType,stepId:6,startNode:'Blockchain',nextNode:'A002',cardNumber:'',txnAmount:'0', cardBank:'Bank A',sourceATM:'', minerATM:minerATM,fee:'0',balance:'0',status:1});
		callclientTFR({txnType:txnType,stepId:7,startNode:'A002',nextNode:'aBank',cardNumber:'',txnAmount:'0', cardBank:'Bank A',sourceATM:'', minerATM:minerATM,fee:'0',balance:'0',status:1});
	}else{
		callclient({txnType:txnType,stepId:6,startNode:'Blockchain',nextNode:'A002',cardNumber:'',txnAmount:'0', cardBank:'Bank A',sourceATM:'', minerATM:minerATM,fee:'0',balance:'0',status:1});
	    callclient({txnType:txnType,stepId:7,startNode:'A002',nextNode:'aBank',cardNumber:'',txnAmount:'0', cardBank:'Bank A',sourceATM:'', minerATM:minerATM,fee:'0',balance:'0',status:1});
	}
...
var postDebitATMPResponse = function(atmpRes, contractOutput){
	...
	if(check[4]==='cdp'){
		...
		callclientTFR({txnType:txnType,stepId:4,startNode:'aBank',nextNode:'A002',cardNumber:'',txnAmount:'0', cardBank:'Bank A',sourceATM:'', minerATM:minerATM,fee:'0',balance:'0',status:1});
		callclientTFR({txnType:txnType,stepId:5,startNode:'A002',nextNode:'Blockchain',cardNumber:'',txnAmount:'0', cardBank:'Bank A',sourceATM:'', minerATM:minerATM,fee:'0',balance:'0',status:1});
	}else{
		callclient({txnType:txnType,stepId:4,startNode:'aBank',nextNode:'A002',cardNumber:'',txnAmount:'0', cardBank:'Bank A',sourceATM:'', minerATM:minerATM,fee:'0',balance:'0',status:1});
		 callclient({txnType:txnType,stepId:5,startNode:'A002',nextNode:'Blockchain',cardNumber:'',txnAmount:'0', cardBank:'Bank A',sourceATM:'', minerATM:minerATM,fee:'0',balance:'0',status:1});
	}
...
var postCreditATMPResponse = function(atmpRes, contractOutput){
	...
	if(check[4]==='cdp'){
		...
		callclientTFR({txnType:txnType,stepId:8,startNode:'aBank',nextNode:'A002',cardNumber:'',txnAmount:'0', cardBank:'Bank A',sourceATM:'', minerATM:minerATM,fee:'0',balance:'0',status:1});
		callclientTFR({txnType:txnType,stepId:9,startNode:'A002',nextNode:'Blockchain',cardNumber:'',txnAmount:'0', cardBank:'Bank A',sourceATM:'', minerATM:minerATM,fee:'0',balance:'0',status:1});

	}else{
		 callclient({txnType:txnType,stepId:8,startNode:'aBank',nextNode:'A002',cardNumber:'',txnAmount:'0', cardBank:'Bank A',sourceATM:'', minerATM:minerATM,fee:'0',balance:'0',status:1});
		 callclient({txnType:txnType,stepId:9,startNode:'A002',nextNode:'Blockchain',cardNumber:'',txnAmount:'0', cardBank:'Bank A',sourceATM:'', minerATM:minerATM,fee:'0',balance:'0',status:1});
...
var commit = function(contractOutput){
	...
	//	_httpRes.end("end:"+contractOutput._status+" "+contractOutput._amount);
		...
		if(statuss[4]==='tfr'){
			...
			callclientTFR({txnType:txnType,stepId:10,startNode:'Blockchain',nextNode:'A002',cardNumber:statuss[0],txnAmount:'0', cardBank:'Bank A',sourceATM:'', minerATM:minerATM,fee:'0',balance:statuss[6],status:2});
		}else{
			callclient({txnType:txnType,stepId:6,startNode:'Blockchain',nextNode:'A002',cardNumber:statuss[0],txnAmount:'0', cardBank:'Bank A',sourceATM:'', minerATM:minerATM,fee:'0',balance:statuss[6],status:2});
		}
...
exports.cwdtxn = function(req, res) {
  ...
  //vars = {data: '4227476428571352|6227497208154181|123456|100|cwd|jhfjfhjs|0|2000|0'};
	if(this.account.issue_bank===this_bank){
		...
		var cwd = {data: this.account.card_number+'|'+'N/A'+'|'+this.account.pin+'|'+this.account.amount+'|'+'cwd'+'|'+trxHash+'|'+0+'|'+2000+'|'+0+'|'+'internal'+'|'+'Bank A'+'|'+'A002'};
		//alert to supv
		//var txnType = '';
		cardBank = 'Bank A';
	    callclient({txnType: txnType,stepId:1,startNode:'A002',nextNode:'aBank',cardNumber:this.account.card_number,txnAmount:this.account.amount, cardBank:cardBank, sourceATM:sourceATM, minerATM:minerATM,fee:'0',balance:'0',status:1});
		console.log(cwd);
		txn_request_atmp.request_transaction(cwd, function(result){
			...
			this.account.balance = statuss[6];
			//alert to supv
		    callclient({txnType:txnType,stepId:2,startNode:'aBank',nextNode:'A002',cardNumber:this.account.card_number,txnAmount:this.account.amount,cardBank:cardBank, sourceATM:sourceATM, minerATM:minerATM,fee:'0',balance:statuss[6],status:2});
		...
		_httpRes = res;
		//fee =2
	  var cwd_outgoing = {data: this.account.card_number+'|'+'N/A'+'|'+this.account.pin+'|'+this.account.amount+'|'+'cwd'+'|'+trxHash+'|'+0+'|'+2000+'|'+2+'|'+'internal'+'|'+'Bank A'+'|'+'A002'};
		...
		//alert to supv
	    callclient({txnType:txnType,stepId:1,startNode:'A002',nextNode:'Blockchain',cardNumber:this.account.card_number,txnAmount:'0', cardBank:cardBank,sourceATM:sourceATM,minerATM:minerATM,fee:'0',balance:'0',status:1});
...
exports.inqtxn = function(req, res) {
		...
		if(this.account.issue_bank===this_bank){
			console.log('internal handling');
	        cardBank = 'Bank A';
			var inq = {data: this.account.card_number+'|'+'N/A'+'|'+this.account.pin+'|'+0+'|'+'inq'+'|'+trxHash+'|'+0+'|'+2000+'|'+0+'|'+'internal'+'|'+'Bank A'+'|'+'A002'};
			//alert to supv
		    callclient({txnType:txnType,stepId:1,startNode:'A002',nextNode:'aBank',cardNumber:this.account.card_number,txnAmount:'',cardBank:cardBank,sourceATM:sourceATM,minerATM:minerATM,fee:'0',balance:'0',status:1});
			txn_request_atmp.request_transaction(inq,function(result){
				...
				this.account.balance = statuss[6];
				//alert to supv
			    callclient({txnType:txnType,stepId:2,startNode:'aBank',nextNode:'A002',cardNumber:this.account.card_number,txnAmount:'',cardBank:cardBank,sourceATM:sourceATM,minerATM:minerATM,fee:'0',balance:statuss[6],status:2});
			...
			_httpRes = res;
			console.log('out going handling');
			var inq_outgoing = {data: this.account.card_number+'|'+'N/A'+'|'+this.account.pin+'|'+0+'|'+'inq'+'|'+trxHash+'|'+0+'|'+2000+'|'+2+'|'+'internal'+'|'+'Bank A'+'|'+'A002'};
			var debitBank;
			if(this.account.issue_bank===bank_b){
				debitBank = BankB;
				cardBank = 'Bank B';
...
exports.cdptxn = function(req, res) {
		...
		if(this.account.issue_bank===this_bank){
			console.log('internal handling');
			cardBank = 'Bank A';
			var cdp = {data: this.account.card_number+'|'+'N/A'+'|'+this.account.pin+'|'+this.account.amount+'|'+'cdp'+'|'+trxHash+'|'+0+'|'+2000+'|'+0+'|'+'internal'+'|'+'Bank A'+'|'+'A002'};
			 callclient({txnType:txnType,stepId:1,startNode:'A002',nextNode:'aBank',cardNumber:this.account.card_number,txnAmount:'',cardBank:cardBank,sourceATM:sourceATM,minerATM:minerATM,fee:'0',balance:'0',status:1});
			...
			console.log(this.account);
			console.log('out going handling');
			var cdp_outging = {data: this.account.card_number+'|'+'N/A'+'|'+this.account.pin+'|'+this.account.amount+'|'+'cdp'+'|'+trxHash+'|'+0+'|'+2000+'|'+2+'|'+'internal'+'|'+'Bank A'+'|'+'A002'};//cdp fee =2
			var _creditBank;
			if(this.account.issue_bank===bank_b){
				_creditBank = BankB;
				cardBank = 'Bank B';
...
exports.tfrtxn = function(req, res) {
	...
	if(this.account.from_issue_bank===this_bank&&this.account.to_issue_bank===this_bank){
		...
		debit_bank = 'Bank A';
		credit_bank = 'Bank A';
		var tfr = {data: this.account.from_card_number+'|'+this.account.to_card_number+'|'+this.account.pin+'|'+this.account.amount+'|'+'tfr'+'|'+trxHash+'|'+0+'|'+2000+'|'+0+'|'+'internal'+'|'+'Bank A'+'|'+'A002'};
		callclientTFR({txnType:txnType,stepId:1,startNode:'A002',nextNode:'aBank',debitAmount:'',debitAccount:this.account.from_card_number,debitBank: debit_bank,creditAccount:this.account.to_card_number,creditBank:credit_bank,sourceATM:sourceATM,debitATM:'',creditATM:'',fee:'0',balance:'0',status:1});
		txn_request_atmp.request_transaction(tfr, function(result){
			var statuss = result.split('|');
			this.account.status = statuss[7];
			this.account.balance = statuss[6];
			//alert to supv
			callclientTFR({txnType:txnType,stepId:2,startNode:'aBank',nextNode:'A002',debitAmount:'',debitAccount:this.account.from_card_number,debitBank: debit_bank,creditAccount:this.account.to_card_number,creditBank:credit_bank,sourceATM:sourceATM,debitATM:'',creditATM:'',fee:'0',balance:statuss[6],status:2});
		...
		console.log(this.account);
		console.log('out going handling');
		var tfr_outging = {data: this.account.from_card_number+'|'+this.account.to_card_number+'|'+this.account.pin+'|'+this.account.amount+'|'+'tfr'+'|'+trxHash+'|'+0+'|'+2000+'|'+3+'|'+'debit'+'|'+'Bank A'+'|'+'A002'};//tfr fee =3
		var _creditBank;
		var _debitBank;
		...
		//alert to supv
		callclientTFR({txnType:txnType,stepId:1,startNode:'A002',nextNode:'Blockchain',debitAmount:'',debitAccount:this.account.from_card_number,debitBank: debit_bank,creditAccount:this.account.to_card_number,creditBank:credit_bank,sourceATM:sourceATM,debitATM:'',creditATM:'',fee:'0',balance:'0',status:1});
		var contractInput ={
				_fromAtm: contractInitVars.atmAdd, 
