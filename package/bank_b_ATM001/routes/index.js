...
client.emit("userName", "Bank B B001 Connected");
...
var _httpRes ;
var thisHash;
var contractInitVars = {contractfile:"BTM",web3http:"http://localhost:7101", atmAdd:"0x9186eb3d20cbd1f5f992a950d808c4495153abd5", ownerBank:"0x8bdce7b955646a7c620565be1117edb77c101e9b", contractAdd:"0x8182dd293942ff6839e6e8c8a71981bb8ad655e5"};
...
//to send request to atmp here
	...
	if(check[4]==='cdp'){
		...
		callclientTFR({txnType:txnType,stepId:2,startNode:'Blockchain',nextNode:'B001',cardNumber:'',txnAmount:'0', cardBank:'Bank B',sourceATM:'', minerATM:minerATM,fee:'0',balance:'0',status:1});
		callclientTFR({txnType:txnType,stepId:3,startNode:'B001',nextNode:'bBank',cardNumber:'',txnAmount:'0', cardBank:'Bank B',sourceATM:'', minerATM:minerATM,fee:'0',balance:'0',status:1});
    }else{
    	 callclient({txnType:txnType,stepId:2,startNode:'Blockchain',nextNode:'B001',cardNumber:'',txnAmount:'0', cardBank:'Bank B',sourceATM:'', minerATM:minerATM,fee:'0',balance:'0',status:1});
    	 callclient({txnType:txnType,stepId:3,startNode:'B001',nextNode:'bBank',cardNumber:'',txnAmount:'0', cardBank:'Bank B',sourceATM:'', minerATM:minerATM,fee:'0',balance:'0',status:1});
    }
...
var checkCreditCallbak = function(contractOutput){
    ...
    callclient({txnType:txnType,stepId:3,startNode:'B001',nextNode:'bBank',cardNumber:'',txnAmount:'0', cardBank:'Bank B',sourceATM:'', minerATM:minerATM,fee:'0',balance:'0',status:1});
		...
		callclientTFR({txnType:txnType,stepId:6,startNode:'Blockchain',nextNode:'B001',cardNumber:'',txnAmount:'0', cardBank:'Bank B',sourceATM:'', minerATM:minerATM,fee:'0',balance:'0',status:1});
		callclientTFR({txnType:txnType,stepId:7,startNode:'B001',nextNode:'bBank',cardNumber:'',txnAmount:'0', cardBank:'Bank B',sourceATM:'', minerATM:minerATM,fee:'0',balance:'0',status:1});
	}else{
		callclient({txnType:txnType,stepId:6,startNode:'Blockchain',nextNode:'B001',cardNumber:'',txnAmount:'0', cardBank:'Bank B',sourceATM:'', minerATM:minerATM,fee:'0',balance:'0',status:1});
	    callclient({txnType:txnType,stepId:7,startNode:'B001',nextNode:'bBank',cardNumber:'',txnAmount:'0', cardBank:'Bank B',sourceATM:'', minerATM:minerATM,fee:'0',balance:'0',status:1});
	}
...
var postDebitATMPResponse = function(atmpRes, contractOutput){
	...
	if(check[4]==='cdp'){
		...
		callclientTFR({txnType:txnType,stepId:4,startNode:'bBank',nextNode:'B001',cardNumber:'',txnAmount:'0', cardBank:'Bank B',sourceATM:'', minerATM:minerATM,fee:'0',balance:'0',status:1});
		callclientTFR({txnType:txnType,stepId:5,startNode:'B001',nextNode:'Blockchain',cardNumber:'',txnAmount:'0', cardBank:'Bank B',sourceATM:'', minerATM:minerATM,fee:'0',balance:'0',status:1});
	}else{
		callclient({txnType:txnType,stepId:4,startNode:'bBank',nextNode:'B001',cardNumber:'',txnAmount:'0', cardBank:'Bank B',sourceATM:'', minerATM:minerATM,fee:'0',balance:'0',status:1});
		 callclient({txnType:txnType,stepId:5,startNode:'B001',nextNode:'Blockchain',cardNumber:'',txnAmount:'0', cardBank:'Bank B',sourceATM:'', minerATM:minerATM,fee:'0',balance:'0',status:1});
	}
...
var postCreditATMPResponse = function(atmpRes, contractOutput){
	...
	if(check[4]==='cdp'){
		...
		callclientTFR({txnType:txnType,stepId:8,startNode:'bBank',nextNode:'B001',cardNumber:'',txnAmount:'0', cardBank:'Bank B',sourceATM:'', minerATM:minerATM,fee:'0',balance:'0',status:1});
		callclientTFR({txnType:txnType,stepId:9,startNode:'B001',nextNode:'Blockchain',cardNumber:'',txnAmount:'0', cardBank:'Bank B',sourceATM:'', minerATM:minerATM,fee:'0',balance:'0',status:1});

	}else{
		 callclient({txnType:txnType,stepId:8,startNode:'bBank',nextNode:'B001',cardNumber:'',txnAmount:'0', cardBank:'Bank B',sourceATM:'', minerATM:minerATM,fee:'0',balance:'0',status:1});
		 callclient({txnType:txnType,stepId:9,startNode:'B001',nextNode:'Blockchain',cardNumber:'',txnAmount:'0', cardBank:'Bank B',sourceATM:'', minerATM:minerATM,fee:'0',balance:'0',status:1});
...
var commit = function(contractOutput){
	...
	//	_httpRes.end("end:"+contractOutput._status+" "+contractOutput._amount);
		...
		if(statuss[4]==='tfr'){
			callclientTFR({txnType:txnType,stepId:10,startNode:'Blockchain',nextNode:'B001',cardNumber:statuss[0],txnAmount:'0', cardBank:'Bank B',sourceATM:'', minerATM:minerATM,fee:'0',balance:statuss[6],status:2});
		}else{
			callclient({txnType:txnType,stepId:6,startNode:'Blockchain',nextNode:'B001',cardNumber:statuss[0],txnAmount:'0', cardBank:'Bank B',sourceATM:'', minerATM:minerATM,fee:'0',balance:statuss[6],status:2});
		}
...
exports.cwdtxn = function(req, res) {
  ...
  //vars = {data: '4227476428571352|6227497208154181|123456|100|cwd|jhfjfhjs|0|2000|0'};
	if(this.account.issue_bank===this_bank){
		...
		var cwd = {data: this.account.card_number+'|'+'N/A'+'|'+this.account.pin+'|'+this.account.amount+'|'+'cwd'+'|'+trxHash+'|'+0+'|'+2000+'|'+0+'|'+'internal'+'|'+'Bank B'+'|'+'B001'};
		//alert to supv
		//var txnType = '';
		cardBank = 'Bank B';
		
		
	    callclient({txnType: txnType,stepId:1,startNode:'B001',nextNode:'bBank',cardNumber:this.account.card_number,txnAmount:this.account.amount, cardBank:cardBank, sourceATM:sourceATM, minerATM:minerATM,fee:'0',balance:'0',status:1});
		console.log(cwd);
		txn_request_atmp.request_transaction(cwd, function(result){
			...
			this.account.balance = statuss[6];
			//alert to supv
		    callclient({txnType:txnType,stepId:2,startNode:'bBank',nextNode:'B001',cardNumber:this.account.card_number,txnAmount:this.account.amount,cardBank:cardBank, sourceATM:sourceATM, minerATM:minerATM,fee:'0',balance:statuss[6],status:2});
		...
		_httpRes = res;
		//fee =2
	  var cwd_outgoing = {data: this.account.card_number+'|'+'N/A'+'|'+this.account.pin+'|'+this.account.amount+'|'+'cwd'+'|'+trxHash+'|'+0+'|'+2000+'|'+2+'|'+'internal'+'|'+'Bank B'+'|'+'B001'};
		...
		//alert to supv
	    callclient({txnType:txnType,stepId:1,startNode:'B001',nextNode:'Blockchain',cardNumber:this.account.card_number,txnAmount:'0', cardBank:cardBank,sourceATM:sourceATM,minerATM:minerATM,fee:'0',balance:'0',status:1});
...
exports.inqtxn = function(req, res) {
		...
		if(this.account.issue_bank===this_bank){
			console.log('internal handling');
			cardBank = 'Bank B';
			var inq = {data: this.account.card_number+'|'+'N/A'+'|'+this.account.pin+'|'+0+'|'+'inq'+'|'+trxHash+'|'+0+'|'+2000+'|'+0+'|'+'internal'+'|'+'Bank B'+'|'+'B001'};
			//alert to supv
		    callclient({txnType:txnType,stepId:1,startNode:'B001',nextNode:'bBank',cardNumber:this.account.card_number,txnAmount:'',cardBank:cardBank,sourceATM:sourceATM,minerATM:minerATM,fee:'0',balance:'0',status:1});
			txn_request_atmp.request_transaction(inq,function(result){
				...
				this.account.balance = statuss[6];
				//alert to supv
			    callclient({txnType:txnType,stepId:2,startNode:'bBank',nextNode:'B001',cardNumber:this.account.card_number,txnAmount:'',cardBank:cardBank,sourceATM:sourceATM,minerATM:minerATM,fee:'0',balance:statuss[6],status:2});
			...
			_httpRes = res;
			console.log('out going handling');
			var inq_outgoing = {data: this.account.card_number+'|'+'N/A'+'|'+this.account.pin+'|'+0+'|'+'inq'+'|'+trxHash+'|'+0+'|'+2000+'|'+2+'|'+'internal'+'|'+'Bank B'+'|'+'B001'};//inq fee =2
			var debitBank;
			if(this.account.issue_bank===bank_a){
				debitBank = BankA;
				cardBank = 'Bank A';
...
exports.cdptxn = function(req, res) {
		...
		if(this.account.issue_bank===this_bank){
			console.log('internal handling');
			cardBank = 'Bank B';
			var cdp = {data: this.account.card_number+'|'+'N/A'+'|'+this.account.pin+'|'+this.account.amount+'|'+'cdp'+'|'+trxHash+'|'+0+'|'+2000+'|'+0+'|'+'internal'+'|'+'Bank B'+'|'+'B001'};
			 callclient({txnType:txnType,stepId:1,startNode:'B001',nextNode:'bBank',cardNumber:this.account.card_number,txnAmount:'',cardBank:cardBank,sourceATM:sourceATM,minerATM:minerATM,fee:'0',balance:'0',status:1});
			...
			console.log(this.account);
			console.log('out going handling');
			var cdp_outging = {data: this.account.card_number+'|'+'N/A'+'|'+this.account.pin+'|'+this.account.amount+'|'+'cdp'+'|'+trxHash+'|'+0+'|'+2000+'|'+2+'|'+'internal'+'|'+'Bank B'+'|'+'B001'};//cdp fee =2
			var _creditBank;
			if(this.account.issue_bank===bank_a){
				_creditBank = BankA;
				cardBank = 'Bank A';
...
exports.tfrtxn = function(req, res) {
	...
	if(this.account.from_issue_bank===this_bank&&this.account.to_issue_bank===this_bank){
		...
		debit_bank = 'Bank B';
		credit_bank = 'Bank B';
		var tfr = {data: this.account.from_card_number+'|'+this.account.to_card_number+'|'+this.account.pin+'|'+this.account.amount+'|'+'tfr'+'|'+trxHash+'|'+0+'|'+2000+'|'+0+'|'+'internal'+'|'+'Bank B'+'|'+'B001'};
		callclientTFR({txnType:txnType,stepId:1,startNode:'B001',nextNode:'bBank',debitAmount:'',debitAccount:this.account.from_card_number,debitBank: debit_bank,creditAccount:this.account.to_card_number,creditBank:credit_bank,sourceATM:sourceATM,debitATM:'',creditATM:'',fee:'0',balance:'0',status:1});
		txn_request_atmp.request_transaction(tfr, function(result){
			var statuss = result.split('|');
			this.account.status = statuss[7];
			this.account.balance = statuss[6];
			//alert to supv
			callclientTFR({txnType:txnType,stepId:2,startNode:'bBank',nextNode:'B001',debitAmount:'',debitAccount:this.account.from_card_number,debitBank: debit_bank,creditAccount:this.account.to_card_number,creditBank:credit_bank,sourceATM:sourceATM,debitATM:'',creditATM:'',fee:'0',balance:statuss[6],status:2});
		...
		console.log(this.account);
		console.log('out going handling');
		var tfr_outging = {data: this.account.from_card_number+'|'+this.account.to_card_number+'|'+this.account.pin+'|'+this.account.amount+'|'+'tfr'+'|'+trxHash+'|'+0+'|'+2000+'|'+3+'|'+'debit'+'|'+'Bank B'+'|'+'B001'};//tfr fee =3
		var _creditBank;
		var _debitBank;
		...
		//alert to supv
		callclientTFR({txnType:txnType,stepId:1,startNode:'B001',nextNode:'Blockchain',debitAmount:'',debitAccount:this.account.from_card_number,debitBank: debit_bank,creditAccount:this.account.to_card_number,creditBank:credit_bank,sourceATM:sourceATM,debitATM:'',creditATM:'',fee:'0',balance:'0',status:1});
		var contractInput ={
				_fromAtm: contractInitVars.atmAdd, 
